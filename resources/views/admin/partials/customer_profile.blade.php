                ...
                <form>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <input type="text" id="first_name" name="first_name" value="Admin" class="w-full px-4 py-2 border border-stone-300 focus:border-stone-500 focus:ring-0 rounded-md">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="email" id="email" name="email" value="admin@elegance.com" class="w-full px-4 py-2 border border-stone-300 focus:border-stone-500 focus:ring-0 rounded-md">
                        </div>
                        <div>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="bio" name="bio" rows="3" class="w-full px-4 py-2 border border-stone-300 focus:border-stone-500 focus:ring-0 rounded-md">Administrator at ELEGANCE, managing the online store and product catalog.</textarea>
                    </div>
