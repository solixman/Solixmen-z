        ...
        <div class="space-y-4">
            ...
            <div class="mt-6">
                ...
                <div id="additional-images-container" class="space-y-3">
                    <!-- Existing additional images would be loaded here -->
                    @if(isset($images))
                        @foreach($images as $image)
                            <div class="additional-image-input flex items-center space-x-2">
                                <div class=" w-12  bg-stone-100 mr-3">
                                    <img src="{{ $image->path }}" alt="{{$product->name}}">
                                </div>
                                <input type="text" name="additional_images[]" value="{{ $image->path }}" class="flex-1 px-4 py-2 border border-stone-300 focus:border-stone-500 focus:ring-0 rounded-md">
