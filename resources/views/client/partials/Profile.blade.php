    ...
    <div class="lg:col-span-1">
        <div class="bg-white rounded-lg shadow-sm border border-stone-100 overflow-hidden">
            <div class="p-6 text-center border-b border-stone-100">
                <div class="h-24 w-24 rounded-full bg-stone-200 mx-auto mb-4 flex items-center justify-center text-stone-600 text-2xl font-medium">
                    <span>AJ</span>
                </div>
                <h3 class="text-lg font-medium">client Johnson</h3>
                <p class="text-sm text-stone-500">client@elegance.com</p>
                <p class="text-sm text-stone-500 mt-1">clientistrator</p>
            ...
            <div class="p-4">
                <nav class="space-y-1">
                    ...
                    <a href="#security" class="block py-2 px-4 rounded-md text-stone-600 hover:bg-stone-50 hover:text-stone-800">
                        Security
                    </a>
                    <a href="#notifications" class="block py-2 px-4 rounded-md text-stone-600 hover:bg-stone-50 hover:text-stone-800">
                        Notifications
                    </a>
                    <a href="#activity" class="block py-2 px-4 rounded-md text-stone-600 hover:bg-stone-50 hover:text-stone-800">
                        Account Activity
                    </a>
                </nav>
            </div>
                ...
                <form>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <input type="text" id="first_name" name="first_name" value="client" class="w-full px-4 py-2 border border-stone-300 focus:border-stone-500 focus:ring-0 rounded-md">
                        </div>
                        <div>
                            <label for="last_name" class="block text-sm font-medium text-stone-700 mb-1">Last Name</label>
                            <input type="text" id="last_name" name="last_name" value="Johnson" class="w-full px-4 py-2 border border-stone-300 focus:border-stone-500 focus:ring-0 rounded-md">
                        </div>
                        <div>
                            <label for="email" class="block text-sm font-medium text-stone-700 mb-1">Email Address</label>
                            <input type="email" id="email" name="email" value="client@elegance.com" class="w-full px-4 py-2 border border-stone-300 focus:border-stone-500 focus:ring-0 rounded-md">
                        </div>
                        <div>
                            <label for="phone" class="block text-sm font-medium text-stone-700 mb-1">Phone Number</label>
                            <input type="tel" id="phone" name="phone" value="+1 (555) 123-4567" class="w-full px-4 py-2 border border-stone-300 focus:border-stone-500 focus:ring-0 rounded-md">
                        </div>
                    </div>
                    
                    <div class="mb-6">
                        <label for="bio" class="block text-sm font-medium text-stone-700 mb-1">Bio</label>
                        <textarea id="bio" name="bio" rows="3" class="w-full px-4 py-2 border border-stone-300 focus:border-stone-500 focus:ring-0 rounded-md">clientistrator at ELEGANCE, managing the online store and product catalog.</textarea>
                    </div>
                    
                    <div class="flex justify-end">
                        <button type="submit" class="px-4 py-2 bg-stone-800 hover:bg-stone-900 text-white rounded-md transition duration-150 ease-in-out">
                            Save Changes
                        </button>
                    </div>
                </form>
                ...
                <form>
                    <div class="space-y-4 mb-6">
                        <div>
                            ...
                            <input type="password" id="current_password" name="current_password" class="w-full px-4 py-2 border border-stone-300 focus:border-stone-500 focus:ring-0 rounded-md">
                        </div>
                        <div>
                            <label for="new_password" class="block text-sm font-medium text-stone-700 mb-1">New Password</label>
                            <input type="password" id="new_password" name="new_password" class="w-full px-4 py-2 border border-stone-300 focus:border-stone-500 focus:ring-0 rounded-md">
                        </div>
                        <div>
                            <label for="confirm_password" class="block text-sm font-medium text-stone-700 mb-1">Confirm New Password</label>
                            <input type="password" id="confirm_password" name="confirm_password" class="w-full px-4 py-2 border border-stone-300 focus:border-stone-500 focus:ring-0 rounded-md">
                        </div>
                    </div>
                    ...
                    <div class="border-t border-stone-100 pt-6 mb-6">
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-sm text-stone-500 mt-1">Currently: <span class="text-red-600">Disabled</span></p>
                            </div>
                            <button type="button" class="px-4 py-2 border border-stone-300 bg-white hover:bg-stone-50 text-stone-700 rounded-md transition duration-150 ease-in-out">
                                Enable
                            </button>
                        </div>
                    </div>
            ...
            <div class="p-6">
                <form>
                    <div class="space-y-4 mb-6">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" id="notify_orders" name="notify_orders" class="h-4 w-4 text-stone-600 focus:ring-stone-500 border-stone-300 rounded" checked>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" id="notify_inventory" name="notify_inventory" class="h-4 w-4 text-stone-600 focus:ring-stone-500 border-stone-300 rounded" checked>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" id="notify_messages" name="notify_messages" class="h-4 w-4 text-stone-600 focus:ring-stone-500 border-stone-300 rounded" checked>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" id="notify_system" name="notify_system" class="h-4 w-4 text-stone-600 focus:ring-stone-500 border-stone-300 rounded">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border-t border-stone-100 pt-6 mb-6">
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center">
                                <input type="checkbox" id="delivery_email" name="delivery_email" class="h-4 w-4 text-stone-600 focus:ring-stone-500 border-stone-300 rounded" checked>
                                <label for="delivery_email" class="ml-2 block text-sm text-stone-700">Email</label>
                            </div>
                            <div class="flex items-center">
                                <input type="checkbox" id="delivery_sms" name="delivery_sms" class="h-4 w-4 text-stone-600 focus:ring-stone-500 border-stone-300 rounded">
                                <label for="delivery_sms" class="ml-2 block text-sm text-stone-700">SMS</label>
                            </div>
                            <div class="flex items-center">
                                <input type="checkbox" id="delivery_browser" name="delivery_browser" class="h-4 w-4 text-stone-600 focus:ring-stone-500 border-stone-300 rounded" checked>
                                <label for="delivery_browser" class="ml-2 block text-sm text-stone-700">Browser Notifications</label>
                            </div>
                        </div>
                    </div>
        ...
        anchor.addEventListener('click', function (e) {
            ...
            if (targetElement) {
                ...
                document.querySelectorAll('nav a').forEach(link => {
                    ...
                    link.classList.add('text-stone-600', 'hover:bg-stone-50', 'hover:text-stone-800');
                });
