                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            <thead class="text-left">
                                <tr>
                                    <th class="px-6 py-3 text-xs font-medium text-stone-500 uppercase tracking-wider">
                                        Products
                                    </th>
                                    <th class="px-6 py-3 text-xs font-medium text-stone-500 uppercase tracking-wider">Price
                                    </th>
                                    <th class="px-6 py-3 text-xs font-medium text-stone-500 uppercase tracking-wider">
                                        Quantity
                                    </th>
                                    <th class="px-6 py-3 text-xs font-medium text-stone-500 uppercase tracking-wider">Total
                                    </th>
                                </tr>
                            </thead>
                            ...
                            <tfoot class="bg-stone-50">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-3 text-sm font-medium">${{ number_format($order->tax ?? 0, 2) }}
                                    </td>
                                </tr>
                                <tr>
                            ...
                            @if ($order->status == 'delivered' || $order->status == 'shipped' || $order->status == 'processing')
                                <div class="flex">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm mt-1">Order has been processed and is being prepared for
                                            shipping.
                                        </p>
                                    </div>
                                </div>
