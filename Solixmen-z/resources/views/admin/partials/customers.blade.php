                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                        <div class="flex space-x-2">
                            <a href="/admin/customer/profile" class="text-stone-600 hover:text-stone-900">View</a>
                            <a href="admin/customer/edit" class="text-stone-600 hover:text-stone-900">Edit</a>
                        </div>
                    </td>
                </tr>
                <tr>
